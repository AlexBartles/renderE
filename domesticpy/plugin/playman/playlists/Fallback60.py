...
s = {'Local': [('CurrentConditions', [8 * 30]), ('RegionalObservationMap', [8 * 30]), ('RegionalDopplerRadar', [8 * 30]), ('TextForecast', [20 * 30]), ('7DayForecast', [16 * 30])], 'BackgroundMusic': [('Default', [60 * 30])], 'Tag': [('Null', [50 * 30]), ('Default', [10 * 30])]}
